...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \ii{Operativsystem --- en samling program som gör det möjligt att köra ``vanliga'' program}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \ii{``Linux'' används ofta som kortform för hela systemet.}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \ii{(Urspringligen) Inte för nybörjare. Enklare nu med grafiska skrivbordsmiljöer.}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \halfblankline
    \ti{Filer och kataloger lagras på ``permanent'' minne (hårddisk, SSD, \ldots).}
