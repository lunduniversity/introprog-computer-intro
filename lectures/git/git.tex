...
\begin{frame}[t]
    \frametitle{Vanlig merge -- skapar en ``merge commit''}
    \begin{center}
        \begin{tikzpicture}
            % Place the image at 50% scale
            \only<1->{
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \ii{``Detatched HEAD'' -- om du checkar ut en specifik commit, snarare än en branch.}
    \end{itemize}
\end{frame}
...
%         \begin{itemize}
%             \ii{Om du har lokala ändringar (i ditt workspace) som inte är committade, kan du inte göra merge.}
