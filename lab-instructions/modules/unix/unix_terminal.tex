...
\begin{Datorarbete}
	...
	\begin{Deluppgifter}
		...
		\item Gå till din hemkatalog och skapa en katalog för de filer som används i denna laboration. Katalogen ska heta \file{lab1} och vara en underkatalog till en katalog \file{dod}, där du ska spara allt som rör kursen Datorer och datoranvändning. Du ska i fortsättningen skapa en ny katalog för varje datorlaboration som du gör. Använd följande kommandon:
